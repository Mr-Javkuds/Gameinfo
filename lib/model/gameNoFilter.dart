...
//
//     final gamenoFilter = gamenoFilterFromJson(jsonString);

import 'dart:convert';

GamenoFilter gamenoFilterFromJson(String str) => GamenoFilter.fromJson(json.decode(str));

String gamenoFilterToJson(GamenoFilter data) => json.encode(data.toJson());
